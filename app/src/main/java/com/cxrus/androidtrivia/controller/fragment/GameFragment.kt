...
import com.cxrus.androidtrivia.databinding.FragmentGameBinding
import com.cxrus.androidtrivia.model.Question
            ...
            if (-1 != checkId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    if (questionIndex < numQuestions) {
                        ...
                        findNavController().navigate(GameFragmentDirections.actionGameFragmentToGameWinFragment(numQuestions, questionIndex))
                    }
                } else {
                    // Game over! A wrong answer sends us to the gameOverFragment.
                    findNavController().navigate(GameFragmentDirections.actionGameFragmentToGameOverFragment2(numQuestions, questionIndex))
                }
            }
        }
